...
$.ajax({
	type:"POST",
	url:"${pageContext.request.contextPath}/productGroup/getAllProductCodeList",
	timeout:20000,
	cache:false,
...
function createTableList(data){
	...
	for(var key in data){
		...
		content+="<td>"+productTypeName(key)+"</td>";
		content+="<td>%</td>";
		content+="</tr>";
	}
...
function search(){
	...
	if(selected=='finance'){
		url="${pageContext.request.contextPath}/finance/financeyieldRatioLine";
