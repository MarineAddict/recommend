 ...
 *
 */
public class DepositClassificationDBUtil {

	private static Logger logger= LoggerFactory.getLogger(DepositClassificationDBUtil.class);
	private static Connection conn;
	public static final String INSERTCATEGORYSTATEMENT="INSERT INTO PRODUCT_CATEGORY VALUES (?,?,?,?,?)";
	public static final String DELETECATEGORYSTATEMENT="DELETE FROM PRODUCT_CATEGORY WhERE PRDTYPE="+ProductType.存款产品.getIndex();
    static{
	...
	public static void deleteDepositCategory(){
