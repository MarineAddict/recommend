...
function createTableList(data){
	...
	for(var i=0;i<data.length;i++){
		content+="<tr>";
		content+="<td>"+data[i].productGroupName+"</td>";
		content+="<td>"+data[i].productCode+"</td>";
		content+="<td>"+data[i].proportion*100+"%</td>";
		content+="</tr>";
	}
...
function search(){
	...
	$.ajax({
		type:"POST",
		url:"${pageContext.request.contextPath}/custom/getCustomGroupInfo",
		data:{planId:'20181',cusId:201801},
		timeout:20000,
		cache:false,
		success:function(data){
